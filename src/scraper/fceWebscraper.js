...
const test = async () => {
  ...
  await page.waitForSelector('a[href="https://wwwp3.smartevals.com/Reporting/Students/Results.aspx?Type=Sections&y=2020&Wizard=True&FiveYearsOnly=True"]');
  await page.click('a[href="https://wwwp3.smartevals.com/Reporting/Students/Results.aspx?Type=Sections&y=2020&Wizard=True&FiveYearsOnly=True"]');
